...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xkNVOv6w9Vl7zuVWBxQtlA
# These lines were loaded from 'lib/NetworkManagement/Schema/Result/Device.pm' found in @INC.
...
1;
# End of lines loaded from 'lib/NetworkManagement/Schema/Result/Device.pm'
# These lines were loaded from 'lib/NetworkManagement/Schema/Result/Device.pm' found in @INC.
# They are now part of the custom portion of this file
# for you to hand-edit.  If you do not either delete
# this section or remove that file from @INC, this section
